    ...
    stages {
        ...
        stage('Release') {
            ...
            steps {
                ...
                // Will be removed
                sh './gradlew ginivision:uploadArchives -PbuildNumber=$BUILD_NUMBER -PmavenSnapshotsRepoUrl=https://repo.gini.net/nexus/content/repositories/snapshots -PrepoUser=$NEXUS_MAVEN_USR -PrepoPassword=$NEXUS_MAVEN_PSW --stacktrace'
