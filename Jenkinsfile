    ...
    stages {
        ...
        stage('Release') {
            ...
            steps {
                ...
                // Will be removed
                sh './gradlew ginivision:uploadArchives -PbuildNumber=$BUILD_NUMBER -PmavenSnapshotsRepoUrl=https://repo.gini.net/nexus/content/repositories/snapshots -PrepoUser=$MAVEN_NEXUS_USR -PrepoPassword=$MAVEN_NEXUS_PSW --stacktrace'
