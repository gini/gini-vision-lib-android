...
class LineItem(
    ...
    override fun toString() = "LineItem(id=$id, description=$description, quantity=$quantity, rawAmount=$rawAmount, amount=$amount, currency=$currency)"
    ...
    override fun hashCode() = Objects.hash(id, description, quantity, rawAmount, amount, currency)
}