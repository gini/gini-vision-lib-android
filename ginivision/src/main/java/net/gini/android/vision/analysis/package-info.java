 ...
 * way of adding network calls to the Gini Vision Library is by creating a {@link
 * net.gini.android.vision.GiniVision} instance with a {@link net.gini.android.vision.network.GiniVisionNetworkService}
 ...
 * <h3>Component API</h3>
 *
 * <p> To use the Component API you have to include the {@link net.gini.android.vision.analysis.AnalysisFragmentStandard}
 * or the {@link net.gini.android.vision.analysis.AnalysisFragmentCompat} in an Activity in your app
 * (a dedicated Activity is recommended). To receive events from the Fragments your Activity must
 * implement the {@link net.gini.android.vision.analysis.AnalysisFragmentListener} interface.
 */
