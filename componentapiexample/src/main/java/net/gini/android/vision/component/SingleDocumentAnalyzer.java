 ...
 * </p>
 * <p>
 *     If the document wasn't modified the analysis started in  {@link GiniVisionActivity#onShouldAnalyzeDocument(Document)} (or {@link GiniVisionAppCompatActivity#onShouldAnalyzeDocument(Document)})
 *     continues the {@link GiniVisionActivity#onAnalyzeDocument(Document)} (or {@link GiniVisionAppCompatActivity#onAnalyzeDocument(Document)}).
 * </p>
 */
